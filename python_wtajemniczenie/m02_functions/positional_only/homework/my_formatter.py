...
def run_example():
    ...
    #     "<greeting>, my name is <name>", greeting="Rafał", name="Pająk"
    # )
    # print(result)

    # result = my_formatter_non_pos("Just output this: <string>", string="Some text")
    # print(result)

    # result = my_formatter("<greeting>, my name is <name>", greeting="Rafał", name="Pająk")
    # print(result)
    #
