...
class ExpressOrder(Order):
    ...
    def __str__(self):
        mark_line = "-" * 20
        order_details = (
            f"Ekspresowe zamówienie złożone przez: {self.client_first_name} {self.client_last_name}"
        )
        ...
        result = "\n".join(
            [mark_line, order_details, value_details, delivery_date, product_details, mark_line]
        )
        return result
